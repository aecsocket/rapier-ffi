...
/**
 * {@snippet :
 * struct RprColliderHandle {
 *     unsigned int index;
 *     unsigned int generation;
 * };
 * }
 */
public class RprColliderHandle {
    ...
    public static MemoryLayout $LAYOUT() {
        return RprColliderHandle.$struct$LAYOUT;
    }
    ...
    public static VarHandle index$VH() {
        return RprColliderHandle.index$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int index$get(MemorySegment seg) {
        return (int)RprColliderHandle.index$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void index$set(MemorySegment seg, int x) {
        RprColliderHandle.index$VH.set(seg, x);
    }
    public static int index$get(MemorySegment seg, long index) {
        return (int)RprColliderHandle.index$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void index$set(MemorySegment seg, long index, int x) {
        RprColliderHandle.index$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle generation$VH() {
        return RprColliderHandle.generation$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int generation$get(MemorySegment seg) {
        return (int)RprColliderHandle.generation$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void generation$set(MemorySegment seg, int x) {
        RprColliderHandle.generation$VH.set(seg, x);
    }
    public static int generation$get(MemorySegment seg, long index) {
        return (int)RprColliderHandle.generation$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void generation$set(MemorySegment seg, long index, int x) {
        RprColliderHandle.generation$VH.set(seg.asSlice(index*sizeof()), x);
    }
