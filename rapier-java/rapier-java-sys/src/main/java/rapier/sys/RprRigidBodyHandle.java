...
/**
 * {@snippet :
 * struct RprRigidBodyHandle {
 *     unsigned int index;
 *     unsigned int generation;
 * };
 * }
 */
public class RprRigidBodyHandle {
    ...
    public static MemoryLayout $LAYOUT() {
        return RprRigidBodyHandle.$struct$LAYOUT;
    }
    ...
    public static VarHandle index$VH() {
        return RprRigidBodyHandle.index$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int index$get(MemorySegment seg) {
        return (int)RprRigidBodyHandle.index$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void index$set(MemorySegment seg, int x) {
        RprRigidBodyHandle.index$VH.set(seg, x);
    }
    public static int index$get(MemorySegment seg, long index) {
        return (int)RprRigidBodyHandle.index$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void index$set(MemorySegment seg, long index, int x) {
        RprRigidBodyHandle.index$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle generation$VH() {
        return RprRigidBodyHandle.generation$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int generation$get(MemorySegment seg) {
        return (int)RprRigidBodyHandle.generation$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void generation$set(MemorySegment seg, int x) {
        RprRigidBodyHandle.generation$VH.set(seg, x);
    }
    public static int generation$get(MemorySegment seg, long index) {
        return (int)RprRigidBodyHandle.generation$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void generation$set(MemorySegment seg, long index, int x) {
        RprRigidBodyHandle.generation$VH.set(seg.asSlice(index*sizeof()), x);
    }
