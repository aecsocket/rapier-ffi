...
public interface RprQueryPipeline_intersections_with_shape$callback {
    ...
    static MemorySegment allocate(RprQueryPipeline_intersections_with_shape$callback fi, MemorySession session) {
        return RuntimeHelper.upcallStub(RprQueryPipeline_intersections_with_shape$callback.class, fi, constants$61.RprQueryPipeline_intersections_with_shape$callback$FUNC, session);
    }
    static RprQueryPipeline_intersections_with_shape$callback ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemorySegment __x0) -> {
            try {
                return (boolean)constants$61.RprQueryPipeline_intersections_with_shape$callback$MH.invokeExact((Addressable)symbol, __x0);
            } catch (Throwable ex$) {
