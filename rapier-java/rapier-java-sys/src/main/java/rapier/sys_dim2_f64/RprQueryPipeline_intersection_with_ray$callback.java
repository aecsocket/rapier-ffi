...
public interface RprQueryPipeline_intersection_with_ray$callback {
    ...
    static MemorySegment allocate(RprQueryPipeline_intersection_with_ray$callback fi, MemorySession session) {
        return RuntimeHelper.upcallStub(RprQueryPipeline_intersection_with_ray$callback.class, fi, constants$55.RprQueryPipeline_intersection_with_ray$callback$FUNC, session);
    }
    static RprQueryPipeline_intersection_with_ray$callback ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemorySegment __x0) -> {
            try {
                return (boolean)constants$55.RprQueryPipeline_intersection_with_ray$callback$MH.invokeExact((Addressable)symbol, __x0);
            } catch (Throwable ex$) {
