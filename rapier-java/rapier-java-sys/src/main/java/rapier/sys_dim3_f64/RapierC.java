...
public class RapierC  {
    ...
    public static MethodHandle RprSharedShape_cone$MH() {
        return RuntimeHelper.requireNonNull(constants$55.RprSharedShape_cone$MH,"RprSharedShape_cone");
    }
    ...
    public static MethodHandle RprSharedShape_cylinder$MH() {
        return RuntimeHelper.requireNonNull(constants$56.RprSharedShape_cylinder$MH,"RprSharedShape_cylinder");
    }
