...
public interface RprQueryPipeline_intersection_with_ray$callback {
    ...
    static MemorySegment allocate(RprQueryPipeline_intersection_with_ray$callback fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(RprQueryPipeline_intersection_with_ray$callback.class, fi, constants$61.RprQueryPipeline_intersection_with_ray$callback$FUNC, scope);
    }
    static RprQueryPipeline_intersection_with_ray$callback ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment __x0) -> {
            try {
                return (boolean)constants$61.RprQueryPipeline_intersection_with_ray$callback$MH.invokeExact(symbol, __x0);
            } catch (Throwable ex$) {
