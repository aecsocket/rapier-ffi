...
public interface RprQueryPipeline_intersections_with_point$callback {
    ...
    static MemorySegment allocate(RprQueryPipeline_intersections_with_point$callback fi, MemorySession session) {
        return RuntimeHelper.upcallStub(RprQueryPipeline_intersections_with_point$callback.class, fi, constants$55.RprQueryPipeline_intersections_with_point$callback$FUNC, session);
    }
    static RprQueryPipeline_intersections_with_point$callback ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemorySegment __x0) -> {
            try {
                return (boolean)constants$55.RprQueryPipeline_intersections_with_point$callback$MH.invokeExact((Addressable)symbol, __x0);
            } catch (Throwable ex$) {
