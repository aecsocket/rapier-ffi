...
public interface RprQueryPipeline_colliders_with_aabb_intersecting_aabb$callback {
    ...
    static MemorySegment allocate(RprQueryPipeline_colliders_with_aabb_intersecting_aabb$callback fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(RprQueryPipeline_colliders_with_aabb_intersecting_aabb$callback.class, fi, constants$58.RprQueryPipeline_colliders_with_aabb_intersecting_aabb$callback$FUNC, scope);
    }
    static RprQueryPipeline_colliders_with_aabb_intersecting_aabb$callback ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment __x0) -> {
            try {
                return (boolean)constants$59.RprQueryPipeline_colliders_with_aabb_intersecting_aabb$callback$MH.invokeExact(symbol, __x0);
            } catch (Throwable ex$) {
