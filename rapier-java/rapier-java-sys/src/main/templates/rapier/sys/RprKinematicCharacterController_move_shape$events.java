...
public interface RprKinematicCharacterController_move_shape$events {
    ...
    static MemorySegment allocate(RprKinematicCharacterController_move_shape$events fi, MemorySession session) {
        return RuntimeHelper.upcallStub(RprKinematicCharacterController_move_shape$events.class, fi, constants$54.RprKinematicCharacterController_move_shape$events$FUNC, session);
    }
    static RprKinematicCharacterController_move_shape$events ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemorySegment __x0) -> {
            try {
                constants$54.RprKinematicCharacterController_move_shape$events$MH.invokeExact((Addressable)symbol, __x0);
            } catch (Throwable ex$) {
