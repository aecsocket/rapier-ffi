...
public interface RprKinematicCharacterController_move_shape$events {
    ...
    static MemorySegment allocate(RprKinematicCharacterController_move_shape$events fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(RprKinematicCharacterController_move_shape$events.class, fi, constants$54.RprKinematicCharacterController_move_shape$events$FUNC, scope);
    }
    static RprKinematicCharacterController_move_shape$events ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment __x0) -> {
            try {
                constants$54.RprKinematicCharacterController_move_shape$events$MH.invokeExact(symbol, __x0);
            } catch (Throwable ex$) {
