...
final class constants$20 {
    ...
    static final FunctionDescriptor RprColliderSet_insert$FUNC = FunctionDescriptor.of(Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    ...
    static final MethodHandle RprImpulseJointSet_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$20.RprImpulseJointSet_new$FUNC
    );
}
