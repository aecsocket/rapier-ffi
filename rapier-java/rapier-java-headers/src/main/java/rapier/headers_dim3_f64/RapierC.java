...
public class RapierC  {
    ...
    /**
     * {@snippet :
     * typedef double RprReal;
     * }
     */
    public static final OfDouble RprReal = Constants$root.C_DOUBLE$LAYOUT;
    ...
    /**
     * {@snippet :
     * struct RprColliderBuilder* RprColliderBuilder_ball(double radius);
     * }
     */
    public static MemorySegment RprColliderBuilder_ball(double radius) {
    ...
    /**
     * {@snippet :
     * struct RprColliderBuilder* RprColliderBuilder_cuboid(double hx, double hy, double hz);
     * }
     */
    public static MemorySegment RprColliderBuilder_cuboid(double hx, double hy, double hz) {
    ...
    public static MethodHandle RprColliderHandle_drop$MH() {
        return RuntimeHelper.requireNonNull(constants$19.RprColliderHandle_drop$MH,"RprColliderHandle_drop");
    }
    /**
     * {@snippet :
     * void RprColliderHandle_drop(struct RprColliderHandle* this_);
     * }
     */
    public static void RprColliderHandle_drop(MemorySegment this_) {
        var mh$ = RprColliderHandle_drop$MH();
        try {
            mh$.invokeExact(this_);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
     ...
     * }
     */
    public static MemorySegment RprColliderSet_insert(MemorySegment this_, MemorySegment coll) {
        var mh$ = RprColliderSet_insert$MH();
        try {
            return (java.lang.foreign.MemorySegment)mh$.invokeExact(this_, coll);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static MethodHandle RprImpulseJointSet_new$MH() {
        return RuntimeHelper.requireNonNull(constants$20.RprImpulseJointSet_new$MH,"RprImpulseJointSet_new");
    }
    /**
     * {@snippet :
    ...
    public static MethodHandle RprMultibodyJointSet_drop$MH() {
        return RuntimeHelper.requireNonNull(constants$21.RprMultibodyJointSet_drop$MH,"RprMultibodyJointSet_drop");
    }
    /**
     * {@snippet :
    ...
    public static MethodHandle RprRigidBodyBuilder_fixed$MH() {
        return RuntimeHelper.requireNonNull(constants$23.RprRigidBodyBuilder_fixed$MH,"RprRigidBodyBuilder_fixed");
    }
    /**
     * {@snippet :
    ...
    public static MethodHandle RprRigidBodyHandle_drop$MH() {
        return RuntimeHelper.requireNonNull(constants$24.RprRigidBodyHandle_drop$MH,"RprRigidBodyHandle_drop");
    }
    /**
     * {@snippet :
     * void RprRigidBodyHandle_drop(struct RprRigidBodyHandle* this_);
     * }
     */
    public static void RprRigidBodyHandle_drop(MemorySegment this_) {
        var mh$ = RprRigidBodyHandle_drop$MH();
        try {
            mh$.invokeExact(this_);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
     ...
     * }
     */
    public static MemorySegment RprRigidBodySet_insert(MemorySegment this_, MemorySegment rb) {
        var mh$ = RprRigidBodySet_insert$MH();
        try {
            return (java.lang.foreign.MemorySegment)mh$.invokeExact(this_, rb);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    public static MethodHandle RprRigidBodySet_new$MH() {
        return RuntimeHelper.requireNonNull(constants$24.RprRigidBodySet_new$MH,"RprRigidBodySet_new");
    }
    /**
     * {@snippet :
