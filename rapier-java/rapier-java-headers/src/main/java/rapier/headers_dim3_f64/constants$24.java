...
final class constants$24 {
    ...
    static final FunctionDescriptor RprRigidBodyHandle_drop$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle RprRigidBodyHandle_drop$MH = RuntimeHelper.downcallHandle(
        "RprRigidBodyHandle_drop",
        constants$24.RprRigidBodyHandle_drop$FUNC
    );
    ...
    static final FunctionDescriptor RprRigidBodySet_insert$FUNC = FunctionDescriptor.of(Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
